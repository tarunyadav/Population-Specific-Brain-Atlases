function [ line_matrix point_matrix] = line_detection_polygon(image_name,detect_length)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

I=dicomread(sprintf('images/%s',image_name));
...
while J(i,j) == 1 && count>0
    ...
    [J E x_coordinates y_coordinates] = anti_clockwise_1(J,E,i,j,x_coordinates, y_coordinates,detect_length);
